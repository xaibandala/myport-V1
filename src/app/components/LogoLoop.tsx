      ...
      const renderLogoItem = useCallback(
        (item: LogoItem, key: React.Key) => {
          ...
          const itemAriaLabel = isNodeItem
            ? ((item as { ariaLabel?: string; title?: string }).ariaLabel ?? (item as { ariaLabel?: string; title?: string }).title)
            : ((item as { alt?: string; title?: string }).alt ?? (item as { alt?: string; title?: string }).title);
